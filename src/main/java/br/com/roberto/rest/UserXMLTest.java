...
//		RestAssured.basePath = "/v2"; //Normalmente altera as versões
	...
	public void devoTrabalharComBaseUri() {
		...
		.then()
			...
			.body("@id", is("3")) // Para XML tudo é String
	...
	public void devoTrabalharComXML() {
		...
		given().when().get("/usersXML/3").then().statusCode(200)
				...
				.rootPath("user").body("name", is("Ana Julia")).body("@id", is("3")) // Para XML tudo é String
	...
	public void devoFazerPesquisasAvancadasComXPath() {
		//Roseta Stone XPath vai mostrar um documento com várias características de busca com XPath
		given()
			.when()
				.get("/usersXML")
			.then()
